...
const ActualizarProducto = () => {
    ...
    fetch(`http://152.70.209.140:8080/api/clothe/${reference}`)
    .then((res) => res.json())
    .then((data) => {
    ...
    const { brand, price, photography, category,quantity,description, presentation } = productosActualizar;
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    try{ console.log(datos);
                        fetch(`http://152.70.209.140:8080/api/clothe/update`, {
                            method: "PUT",
         ...
         > 
             ...
             <div className="mb-4">
                 ...
                 <input 
                     ...
                     value={formik.values.presentation || presentation}
                     onChange={formik.handleChange}   
                 />
             </div>
